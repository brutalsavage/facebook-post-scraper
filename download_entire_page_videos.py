...
if __name__ == '__main__':
    ...
    required_parser.add_argument('--chromedriver', '-c', help="The path to the local chromedriver binary", required=True)
    ...
    page_data = extract(args.chromedriver, args.fbpage, int(args.numofposts))
